 ...
 */
function generateDescription(colorAnalysis, shapeAnalysis, contentAnalysis, styleAnalysis) {
  ...
  return `${type} в ${orientation} ориентации с ${colorDesc} цветами, содержащее ${mainObjects}, ${complexity} композиция, ${styleAnalysis}`;
}
